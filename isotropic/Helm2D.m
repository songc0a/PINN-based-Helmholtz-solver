function H= Helm2D(k,o,d,n,nb)
%===============介绍说明==============================================
% 2D Helmholtz operator, discretized using `optimal' 9-point stencil 
%[Jo et al '96, Geophysics 62(2), 529-537]
...
% construct matrix
H  = (gamma*speye(N) + delta*A0 + .25*(1-gamma-4*delta)*A45)*E + alpha*L0 + (1-alpha)*L45;
